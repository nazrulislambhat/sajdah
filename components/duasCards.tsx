...
export default function Duas() {
  ...
  return (
    <div className="border-PrimarySalahSync px-8 py-12 border-2 h-fit w-fit xl:w-fit bg-WhiteSalahSync  boxed rounded-lg flex flex-col items-center justify-center pt-6">
      ...
      <div className="gap-4 grid xl:grid-cols-2 sm:grid-cols-2 xl:px-12 xl:pb-12 pt-10">
        {shuffledduass
          .slice(0, 8)
