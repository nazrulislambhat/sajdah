...
export default function Duas() {
  ...
  return (
    <div className="border-Primarysajdah px-8 py-12 border-2 h-fit w-fit xl:w-fit bg-Whitesajdah  boxed rounded-lg flex flex-col items-center justify-center pt-6">
